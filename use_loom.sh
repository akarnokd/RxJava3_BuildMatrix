...
wget -nv https://download.java.net/java/early_access/loom/4/openjdk-18-loom+4-273_linux-x64_bin.tar.gz
tar -zxvf openjdk-18-loom+4-273_linux-x64_bin.tar.gz
